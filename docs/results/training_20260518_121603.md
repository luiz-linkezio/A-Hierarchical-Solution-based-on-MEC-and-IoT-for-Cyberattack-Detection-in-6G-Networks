# Training Results — 2026-05-18 12:16:03
...
Shape after all cleaning steps: `(703393, 56)`
...
**Train / test split:** 562,714 / 140,679 flows (80/20, stratified)
...
| Parameter | Value |
|-----------|-------|
| `threshold` | `0.17897237372242913` |
| `num_leaves` | `182` |
| `max_depth` | `0` |
| `min_child_samples` | `31` |
| `min_split_gain` | `0.7494153638863204` |
| `learning_rate` | `0.046111547485047366` |
| `n_estimators` | `368` |
| `subsample` | `0.7333657116131644` |
| `subsample_freq` | `1` |
| `colsample_bytree` | `0.6102967704135666` |
| `reg_alpha` | `2.0790087941296376e-08` |
| `reg_lambda` | `1.658671176979048e-08` |
| `max_bin` | `133` |

### Feature Importance

![Phase 1 — Feature Importance (top 20)](images/20260518_121603_p1_feature_importance.png)
...
### Evaluation (test set — 140,679 flows)

Decision threshold: `0.17897237372242913`

```
              precision    recall  f1-score   support

      attack       0.68      0.96      0.80     57365
      benign       0.96      0.69      0.80     83314

    accuracy                           0.80    140679
   macro avg       0.82      0.82      0.80    140679
weighted avg       0.85      0.80      0.80    140679
```
...
| Artifact | Path |
|----------|------|
| Binary classifier | `models/binary_classifier_20260518_121603.pkl` |
| Threshold written to script | `scripts/network_binary_ids.py` → `THRESHOLD = 0.17897237372242913` |
